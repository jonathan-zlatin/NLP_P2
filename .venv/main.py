...
word_tag_freq = ConditionalFreqDist((word, tag) for sentence in train_set for (word, tag) in sentence)
...
most_likely_tag.setdefault('default', 'NN')
...
for sentence in test_set:
    for word, actual_tag in sentence:
        ...
        predicted_tag = most_likely_tag.get(word, most_likely_tag['default'])
